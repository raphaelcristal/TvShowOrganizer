...
alter table users add constraint fk_users_settings_5 foreign key (settings_id) references settings (id) on delete restrict on update restrict;
create index ix_users_settings_5 on users (settings_id);
